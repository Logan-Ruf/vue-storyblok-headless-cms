...
<template>
  <div class="relative bg-white">
    <div class="pb-10 pt-10 sm:pb-28 lg:grid lg:grid-cols-11 lg:grid-rows-2 lg:gap-x-8 lg:px-0 lg:pb-20 lg:pt-20">
      <div class="mx-auto px-6 md:pl-20 lg:col-span-6 lg:mx-0 xl:col-span-5">
