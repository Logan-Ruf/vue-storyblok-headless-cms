...
<template>
  <section v-editable="props.blok" class="flex max-w-3xl flex-grow flex-wrap items-end justify-between gap-6 px-6">
    <div class="flex flex-col gap-4">
      <div class="flex flex-row items-center gap-x-4">
        <span class="inline-flex h-10 w-10 rotate-45 transform rounded-t-full rounded-bl-full bg-black">
          <Icon :name="props.blok.icon" class="m-auto h-5 w-5 -rotate-45 text-white" />
        </span>
