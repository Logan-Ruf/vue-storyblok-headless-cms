...
<template>
  <div v-if="show" class="flex items-center gap-x-6 bg-sand-700 px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
    <NuxtLink :to="props.blok.link?.url" class="leading-6 text-white">
